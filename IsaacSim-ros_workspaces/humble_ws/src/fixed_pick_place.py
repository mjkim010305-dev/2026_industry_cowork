...
# 현재 hardware.launch.py 실행 후 자동으로 잡힌 안정 자세
P_HOME: Optional[List[float]] = [
    -0.0015339807878856412 - 1.5707963268, -1.0461748973380072,
      1.0753205323078345, 0.009203884727313847     # joint4
]

# 물체 위쪽 자세
P_PRE_PICK: Optional[List[float]] = [
    -0.019941750242513337 - 1.5707963268, 0.8375535101855601,
      -0.12578642460662257, -0.8436894333371027     # joint4
]

# 물체를 실제로 잡는 낮은 자세
P_PICK: Optional[List[float]] = [
    -0.02454369260617026 - 1.5707963268, 1.2885438618239387,
      -0.7731263170943632, -0.4816699673960913    # joint4
]

# 물체를 잡고 위로 들어올린 자세
P_LIFT: Optional[List[float]] = [
    -0.02454369260617026 - 1.5707963268, 0.518485063053467,
      0.04908738521234052, -0.6181942575179133     # joint4
]

# 물체를 든 채 터틀봇이 이동하기 좋은 안전 자세
P_CARRY: Optional[List[float]] = [
    -0.039883500485026674 - 1.5707963268, -0.9188544919434991,
      0.48013598600820567, 0.4724660826687775     # joint4
]
