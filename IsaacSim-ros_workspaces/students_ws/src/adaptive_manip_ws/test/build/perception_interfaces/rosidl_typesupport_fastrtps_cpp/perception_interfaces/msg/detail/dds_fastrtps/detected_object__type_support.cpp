...
#include "perception_interfaces/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const perception_interfaces::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_interfaces::msg::DetectedObject & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_interfaces::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const perception_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_interfaces, msg, DetectedObject)() {
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
