...
bool perception_interfaces__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_interfaces.msg._detected_object.DetectedObject", full_classname_dest, 57) == 0);
  }
  perception_interfaces__msg__DetectedObject * ros_message = _ros_message;
  {  // id
...
PyObject * perception_interfaces__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_interfaces.msg._detected_object");
