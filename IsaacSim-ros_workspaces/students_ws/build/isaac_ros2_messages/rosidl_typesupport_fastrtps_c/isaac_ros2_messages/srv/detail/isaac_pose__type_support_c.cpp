  ...
  void * untyped_ros_message)
{
  ...
  _IsaacPose_Request__ros_msg_type * ros_message = static_cast<_IsaacPose_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _IsaacPose_Response__ros_msg_type * ros_message = static_cast<_IsaacPose_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
